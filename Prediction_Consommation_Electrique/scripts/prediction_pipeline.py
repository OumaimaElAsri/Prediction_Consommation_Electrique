"""
Pipeline End-to-End: Data Cleaning → Feature Engineering → Modeling → Predictions

Orchestrateur principal qui chaîne tous les staps:
1. Charger données énergétiques
2. Nettoyage & fusion
3. Feature engineering avancé
4. Modélisation XGBoost
5. Prédictions & export
...
class PredictionPipeline:
    """Orchestrateur principal du pipeline de prédiction complète."""
    ...
    def __init__(self,
        ...
        """
        Initialise le pipeline de prédiction complet.
        
        Args:
            meteo_path: Répertoire données météo
            rte_path: Répertoire données RTE
            output_path: Répertoire output intermédiaire
            data_processed_path: Chemin du fichier final processed_data.csv
        """
    ...
    def run(self) -> Tuple[pd.DataFrame, Dict]:
        ...
        Étapes:
        1. Charger & nettoyer données
        2. Feature engineering avancé
        3. Modélisation XGBoost
        4. Prédictions & export
        
        Returns:
            Tuple (dataset_final, results_dict)
        """
        logger.info("\n" + "█"*80)
        ...
        # Créer le dataset final avec toutes les infos
    ...
    def _create_final_dataset(self, 
        ...
        """
        Crée le dataset final avec toutes les colonnes pertinentes.
        ...
        Args:
            ...
            predictions_df: DataFrame de prédictions
        ...
        # Fusionner les prédictions avec les features
